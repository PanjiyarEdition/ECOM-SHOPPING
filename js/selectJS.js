(function (c) {
  ...
  c.widget("selectBox.selectBoxIt", {
    ...
    _create: function (a) {
      ...
      if (this.element.is("select"))
        return (
          (this.widgetProto = c.Widget.prototype),
          (this.originalElem = this.element[0]),
          (this.selectBox = this.element),
          this.options.populate && this.add && !a && this.add(b),
          (this.selectItems = this.element.find("option")),
          (this.firstSelectItem = this.selectItems.slice(0, 1)),
          (this.documentHeight = c(v).height()),
          (this.theme = c.isPlainObject(d)
            ? c.extend({}, this.getThemes()["default"], d)
            : this.getThemes()[d]
            ? this.getThemes()[d]
            : this.getThemes()["default"]),
          (this.currentFocus = 0),
          (this.blur = !0),
          (this.textArray = []),
          (this.currentIndex = 0),
          (this.currentText = ""),
          (this.flipped = !1),
          a || (this.selectBoxStyles = this.selectBox.attr("style")),
          this._createDropdownButton()
            ._createUnorderedList()
            ._copyAttributes()
            ._replaceSelectBox()
            ._addClasses(this.theme)
            ._eventHandlers(),
    ...
    _createUnorderedList: function () {
      ...
      a.options.showFirstOption ||
        (a.selectItems.first().attr("disabled", "disabled"),
        (a.selectItems = a.selectBox.find("option").slice(1)));
      a.selectItems.each(function (l) {
        k = c(this);
        e = d = "";
        b = k.prop("disabled");
        g = k.attr("data-icon") || "";
        m = (f = k.attr("data-iconurl") || "")
          ? "selectboxit-option-icon-url"
          : "";
        h = f ? "style=\"background-image:url('" + f + "');\"" : "";
        t = k.attr("data-selectedtext");
        p = (u = k.attr("data-text")) ? u : k.text();
        q = k.parent();
        q.is("optgroup") &&
          ((d = "selectboxit-optgroup-option"),
          0 === k.index() &&
            (e =
        ...
        r +=
          ...
          h +
          "></i></span>" +
          (a.options.html ? p : a.htmlEscape(p)) +
          "</a></li>";
        s = k.attr("data-search");
        a.textArray[l] = b ? "" : s ? s : p;
        this.selected &&
          (a._setText(a.dropdownText, t || p), (a.currentFocus = l));
      });
      if (a.options.defaultText || a.selectBox.attr("data-text")) {
        var n = a.options.defaultText || a.selectBox.attr("data-text");
        a._setText(a.dropdownText, n);
        a.options.defaultText = n;
      }
      l.append(r);
      a.list = l;
      ...
      a.list
        ...
        .not(".optgroupHeader")
        .addClass(a.theme.disabled);
      a.dropdownImage.addClass(
        a.selectBox.attr("data-icon") ||
          a.options.defaultIcon ||
          a.listItems.eq(a.currentFocus).find("i").attr("class")
      );
      a.dropdownImage.attr(
        "style",
        a.listItems.eq(a.currentFocus).find("i").attr("style")
      );
      return a;
    },
    _replaceSelectBox: function () {
      var a = this.originalElem.id || "",
        ...
        b = (this.listSize = b === w ? "auto" : "0" === b ? "auto" : +b),
        d;
      ...
      this.options.autoWidth &&
        (this.dropdown
          .css({ width: "auto" })
          .css({ width: this.list.outerWidth(!0) + a + d }),
        this.list.css({ "min-width": this.dropdown.width() }));
      ...
      "number" === c.type(b) &&
        (this.maxHeight = this.listAnchors.outerHeight(!0) * b);
      return this;
    },
    _scrollToView: function (a) {
      ...
      "search" === a
        ? f - b < c
          ? this.list.scrollTop(d + (b - (f - c)))
          : -1 > b && this.list.scrollTop(b - c)
        : "up" === a
        ? -1 > b && this.list.scrollTop(d - g)
        : "down" === a && f - b < c && this.list.scrollTop(d + (g - f + c));
      return this;
    },
    ...
    _eventHandlers: function () {
      ...
      this.dropdown.on({
        "click.selectBoxIt": function () {
          ...
          a.originalElem.disabled ||
            (a.triggerEvent("click"), b || d || a.toggle());
        },
        ...
        "focus.selectBoxIt": function (b, d) {
          ...
          d ||
            (c(this).hasClass(a.theme.disabled) || c(this).addClass(f),
            a.triggerEvent("focus"));
        },
        "keydown.selectBoxIt": function (b) {
          ...
          d &&
            (d(),
            !a.options.keydownOpen || ("up" !== c && "down" !== c) || a.open());
      ...
      a.list.on(
        {
          "mousedown.selectBoxIt": function () {
            ...
            "false" === c(this).attr("data-disabled") &&
              "true" !== c(this).attr("data-preventclose") &&
              a.close();
            setTimeout(function () {
              a.dropdown.trigger("focus", !0);
            }, 0);
          ...
          "focusin.selectBoxIt": function () {
            ...
            ((a.options.searchWhenHidden && b) ||
              a.options.aggressiveChange ||
              (b && a.options.selectWhenHidden)) &&
              a._update(c(this));
            c(this).addClass(f);
          },
          "mouseup.selectBoxIt": function () {
          ...
          "mouseenter.selectBoxIt": function () {
            "false" === c(this).attr("data-disabled") &&
              (a.listItems.removeAttr("data-active"),
              c(this).addClass(f).attr("data-active", ""),
              a.listItems.not(c(this)).removeClass(f),
              c(this).addClass(f),
              (a.currentFocus = +c(this).attr("data-id")));
          },
          "mouseleave.selectBoxIt": function () {
            "false" === c(this).attr("data-disabled") &&
              (a.listItems
      ...
      a.selectBox.on({
        "change.selectBoxIt, internal-change.selectBoxIt": function (b, c) {
          var d, f;
          c ||
            ((d = a.list.find('li[data-val="' + a.originalElem.value + '"]')),
            d.length &&
              (a.listItems.eq(a.currentFocus).removeClass(a.focusClass),
              (a.currentFocus = +d.attr("data-id"))));
          ...
          d.find("i").attr("class") &&
            (a.dropdownImage
              .attr("class", d.find("i").attr("class"))
              .addClass("selectboxit-default-icon"),
            a.dropdownImage.attr("style", d.find("i").attr("style")));
        ...
        "open.selectBoxIt": function () {
          var b = a.list.find(
            "li[data-val='" + a.dropdownText.attr("data-val") + "']"
          );
          b.length || (b = a.listItems.not("[data-disabled=true]").first());
          a.currentFocus = +b.attr("data-id");
          b = a.listItems.eq(a.currentFocus);
          a.dropdown.addClass(h).removeClass(m).addClass(f);
          a.listItems
            .removeClass(a.selectedClass)
            .removeAttr("data-active")
            .not(b)
            .removeClass(f);
        ...
        "mouseenter.selectBoxIt": function () {
          c(this).hasClass(a.theme.disabled) || a.dropdown.addClass(m);
        },
        "mouseleave.selectBoxIt": function () {
    ...
    _update: function (a) {
      var b,
        c = this.options.defaultText || this.selectBox.attr("data-text"),
      ...
      "false" === a.attr("data-disabled") &&
        ...
        this.selectBox.val() === a.attr("data-val")
          ...
          : (this.selectBox.val(a.attr("data-val")),
            (this.currentFocus = +a.attr("data-id")),
            this.originalElem.value !== this.dropdownText.attr("data-val") &&
              this.triggerEvent("change")));
    },
    _addClasses: function (a) {
      ...
      this.downArrow.addClass(
        this.selectBox.attr("data-downarrow") || this.options.downArrowIcon || e
      );
    ...
    triggerEvent: function (a) {
      this.selectBox.trigger(a, {
        ...
        selectboxOption: this.selectItems.eq(
          this.options.showFirstOption
            ? this.currentFocus
  ...
  h._addAttributes = function (a, b) {
    var d = this.options.copyAttributes;
    a.length &&
      c.each(a, function (a, g) {
        var f = g.name.toLowerCase(),
          h = g.value;
        "null" === h ||
          (-1 === c.inArray(f, d) && -1 === f.indexOf("data")) ||
          b.attr(f, h);
      });
    return this;
  };
  h._dynamicPositioning = function () {
    if ("number" === c.type(this.listSize))
      ...
      f
        ? this.dropdown.offset().top - e >= b
          ? (this.list.css("max-height", b),
            this.list.css(
              "top",
              this.dropdown.position().top - this.list.outerHeight()
            ))
          : ((a = Math.abs(a + d + b - (g + e))),
            (g = Math.abs(this.dropdown.offset().top - e - b)),
            a < g
              ? (this.list.css("max-height", b - a - d / 2),
                this.list.css("top", "auto"))
              : (this.list.css("max-height", b - g - d / 2),
                this.list.css(
                  "top",
                  this.dropdown.position().top - this.list.outerHeight()
                )))
        : (this.list.css("max-height", b), this.list.css("top", "auto"));
    }
    return this;
  };
  ...
  h.remove = function (a, b) {
    var d = this,
      ...
      h = "";
    if ("array" === e) {
      for (f = a.length; g <= f - 1; g += 1)
        (e = a[g]),
          "number" === c.type(e) &&
            (h = h.length
              ? h + (", option:eq(" + e + ")")
              : h + ("option:eq(" + e + ")"));
      d.selectBox.find(h).remove();
    } else
      "number" === e
        ? d.selectBox.find("option").eq(a).remove()
        : d.selectBox.find("option").remove();
    d.dropdown
      ? d.refresh(function () {
