          ...
          container.find(".tp-caption iframe").each(function (i) {
            try {
              if (jQuery(this).attr("src").indexOf("you") > 0 && addedyt == 0) {
                ...
                s.src =
                  httpprefix +
                  "://www.youtube.com/player_api"; /* Load Player API*/
                ...
                jQuery("head")
                  ...
                  .each(function () {
                    if (
                      ...
                      httpprefix + "://www.youtube.com/iframe_api"
                    )
                      loadit = false;
                  });
        ...
        TweenLite.fromTo(
          ...
          },
          {
            ...
            onUpdate: function () {
              ...
              if (!isIE(8))
                defimg.data("currotate", getRotationDegrees(defimg));
              if (!isIE(8))
                defimg.data("curscale", defimg.css("backgroundSize"));
            },
          }
        )
      );
    ...
    nextli.find(".tp-caption").each(function (i) {
      ...
      if (handlecaption == 0) {
                  ...
                  videojs(videoID).ready(function () {
                    ...
                    html5vid.data(
                      ...
                      setTimeout(function () {
                        ...
                        if (
                          html5vid.closest(".tp-caption").data("volume") ==
                          "mute"
                        )
                          myPlayer.volume(0);
        ...
        if (nextcaption.find("img").length > 0) {
          ...
          if (
            nextcaption.find("iframe").length > 0 ||
            nextcaption.find(".video-js").length > 0
          ) {
  ...
  function endMoveCaption(nextcaption, opt, mdelay) {
    ...
    if (
      ...
      if (nextcaption.hasClass("ltr") || nextcaption.hasClass("skewtoright"))
        ...
        xx = 0 - (opt.width + 60);
      else if (nextcaption.hasClass("ltt")) yy = 0 - (opt.height + 60);
