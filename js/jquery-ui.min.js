    ...
    (t.widget.bridge = function (i, n) {
      ...
      t.fn[i] = function (o) {
        var r = "string" == typeof o,
          ...
          l = this;
        return (
          (o = !r && h.length ? t.widget.extend.apply(null, [o].concat(h)) : o),
          r
            ? this.each(function () {
                var s,
                  n = t.data(this, a);
    ...
    (t.Widget.prototype = {
      ...
      _on: function (i, s, n) {
        ...
        "boolean" != typeof i && ((n = s), (s = i), (i = !1)),
          n
            ? ((s = a = t(s)), (this.bindings = this.bindings.add(s)))
...
(function (t, e) {
  function i(t, e, i) {
    return [
      parseInt(t[0], 10) * (d.test(t[0]) ? e / 100 : 1),
      parseInt(t[1], 10) * (d.test(t[1]) ? i / 100 : 1),
    ];
  }
  function s(e, i) {
  ...
  (t.position = {
    ...
    (t.fn.position = function (e) {
      ...
      return (
        9 === y.nodeType
          ? ((d = v.width()), (f = v.height()), (g = { top: 0, left: 0 }))
          : t.isWindow(y)
          ? ((d = v.width()),
            (f = v.height()),
        ...
        this.each(function () {
          ...
          "right" === e.my[0]
            ...
            "bottom" === e.my[1]
              ? (M.top -= p)
              : "center" === e.my[1] && (M.top -= p / 2),
            (M.left += I[0]),
            (M.top += I[1]),
            t.support.offsetFractions ||
              ((M.left = r(M.left)), (M.top = r(M.top))),
            (l = { marginLeft: y, marginTop: D }),
            ...
            e.using &&
              (h = function (t) {
                ...
                u > d && d > o(i + s) && (l.horizontal = "center"),
                  p > f && f > o(n + r) && (l.vertical = "middle"),
                  (l.important =
                    a(o(i), o(s)) > a(o(n), o(r)) ? "horizontal" : "vertical"),
            ...
            switch (
              ...
              case e.ui.keyCode.PAGE_UP:
                a = this._trimAlignValue(
                  n + (this._valueMax() - this._valueMin()) / t
                );
                break;
              case e.ui.keyCode.PAGE_DOWN:
                a = this._trimAlignValue(
        ...
        : ((this.elementSize = {
          ...
          r === !1
            ...
            : ((this._mouseSliding = !0),
              ...
              (l = a.offset()),
              (h = !e(t.target).parents().andSelf().is(".ui-slider-handle")),
              (this._clickOffset = h
                ? { left: 0, top: 0 }
                : {
      ...
      this.options.values && this.options.values.length
        ? this.handles.each(function (s) {
            (i =
              ...
              e(this).stop(1, 1)[h ? "animate" : "css"](u, r.animate),
              l.options.range === !0 &&
